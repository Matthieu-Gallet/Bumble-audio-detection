...
def get_dataloader_site(path_wavfile, meta_site ,Fmin, Fmax, batch_size=12):
    ...
    site_set = Silent_dataset(meta_dataloader.reset_index(drop=True),Fmin, Fmax, np.min(meta_site['dB']))
