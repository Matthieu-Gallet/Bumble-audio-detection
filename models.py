...
from utils.stft import Spectrogram, LogmelFilterBank
from utils.augmentation import SpecAugmentation
...
### Added the define panns model function and the converstion to HF


def define_panns_model(
    window_size=1024,
    hop_size=320,
    mel_bins=64,
    fmin=50,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--checkpoint_path",
        default="ResNet22_mAP=0.430.pth",
        type=str,
